...
<body class="body">
    <?php
        ...
        echo "<br><br><p class='h1'>Encuentra tus artículos favoritos</p><br><br>";
        ...
        $cont = 0; 
        while ($row_producto = $res->fetch_array()) {
            $id             = $row_producto['id'];
            ...
            echo "
                <div class='card' style='width: 16rem;'>
                    ...
                    <div class='card-body'>
                        <h5 class='card-title text' onclick='ver_detalles($id)'>$nombre</h5>
